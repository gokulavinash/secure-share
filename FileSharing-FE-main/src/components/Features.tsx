      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Enterprise-Grade Security, <br className="hidden sm:block" />Simple User Experience
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with cutting-edge encryption technology to protect your files at every step of the sharing process.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Files are encrypted with AES-256-CBC before upload. Only authorized recipients can decrypt and access your files."
            index={0}
          />
          <FeatureCard
            ...
            description="Every download request requires admin approval, ensuring complete control over who accesses your sensitive files."
            index={1}
          />
          <FeatureCard
            ...
            description="Files are stored encrypted in the cloud with Cloudinary, ensuring your data is safe and accessible only to authorized users."
            index={2}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M12 2a10 10 0 1 0 10 10 4 4 0 1 1-4-4"></path><path d="M12 8a4 4 0 1 0 4 4"></path></svg>}
            title="User-Specific Keys"
            description="Each user has their own encryption key, ensuring files can only be decrypted by the intended sender and recipient."
            index={3}
          />
          <FeatureCard
            ...
            title="Audit Logging"
            description="Complete audit trail of all file operations, including uploads, downloads, approvals, and rejections for compliance."
            index={4}
          />
          <FeatureCard
            ...
            description="Share up to 2 files (10MB each) with any email address. Recipients get notified and can request download access."
            index={5}
          />
        </div>
      </div>
